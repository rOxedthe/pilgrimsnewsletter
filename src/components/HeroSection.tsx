      ...
      <div className="container relative z-10 grid min-h-[75vh] grid-cols-1 items-center gap-12 py-20 lg:grid-cols-2">
        ...
        <div className="space-y-8 animate-fade-in">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              to="/subscribe"
              className="group inline-flex items-center gap-2 rounded bg-primary px-6 py-3 font-body text-sm font-semibold uppercase tracking-wider text-primary-foreground transition-all hover:brightness-125"
            >
            ...
            <a
              ...
              className="group inline-flex items-center gap-2 rounded border border-secondary/50 px-6 py-3 font-body text-sm font-semibold uppercase tracking-wider text-secondary transition-all hover:bg-secondary/10 gold-glow"
            >
        ...
        <div className="hidden lg:flex flex-col items-end gap-6 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
          <div className="space-y-6 rounded border border-secondary/20 bg-foreground/30 p-8 backdrop-blur-md">
            ...
            <div className="grid grid-cols-3 gap-6 border-t border-secondary/20 pt-6">
              {[
                { num: "40+", label: "Years" },
                ...
                <div key={s.label} className="text-center">
                  <div className="font-headline text-3xl font-bold text-secondary">{s.num}</div>
