...
const FIELD_LABELS: Record<string, { label: string; type: "text" | "textarea" | "image" | "url" }> = {
  hero_title_line1: { label: "Hero Title Line 1", type: "text" },
  hero_title_line2: { label: "Hero Title Line 2 (Accent)", type: "text" },
  hero_description: { label: "Hero Description", type: "textarea" },
  hero_cta_primary_text: { label: "Primary CTA Text", type: "text" },
  hero_cta_primary_link: { label: "Primary CTA Link", type: "url" },
  hero_cta_secondary_text: { label: "Secondary CTA Text", type: "text" },
  hero_cta_secondary_link: { label: "Secondary CTA Link", type: "url" },
  hero_quote: { label: "Hero Quote", type: "textarea" },
  hero_stat_1_num: { label: "Stat 1 Number", type: "text" },
  hero_stat_1_label: { label: "Stat 1 Label", type: "text" },
  hero_stat_2_num: { label: "Stat 2 Number", type: "text" },
  hero_stat_2_label: { label: "Stat 2 Label", type: "text" },
  hero_stat_3_num: { label: "Stat 3 Number", type: "text" },
  hero_stat_3_label: { label: "Stat 3 Label", type: "text" },
  ticker_item_1: { label: "Ticker Item 1", type: "text" },
  ticker_item_2: { label: "Ticker Item 2", type: "text" },
  ticker_item_3: { label: "Ticker Item 3", type: "text" },
  ticker_item_4: { label: "Ticker Item 4", type: "text" },
  ticker_item_5: { label: "Ticker Item 5", type: "text" },
